...
---
## 📊 Dashboard
This project also includes a full Streamlit dashboard with 5 pages:
- 🏠 **Overview** — Project summary and key metrics
- 📧 **Email Classifier** — Live spam/ham detection
- 📊 **Model Performance** — Classification report and confusion matrix
- 📈 **Dataset Statistics** — Ham vs spam distribution charts
- 🚨 **Flagged Emails** — Log of incorrectly classified emails
...
├── gui_screenshot.png            # Gradio GUI screenshot
